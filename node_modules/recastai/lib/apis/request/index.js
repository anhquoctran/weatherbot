        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 5:
              ...
              _context4.next = 10;
              return request.attach('voice', file).send(data);

            case 10:
              res = _context4.sent;
              return _context4.abrupt('return', new _resources.Conversation((0, _extends3.default)({}, res.body.results, { recastToken: _this.token })));

            case 14:
              _context4.prev = 14;
              _context4.t0 = _context4['catch'](5);
              throw new _resources.RecastError(_context4.t0.message);
